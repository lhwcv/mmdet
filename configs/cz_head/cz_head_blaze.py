...
model = dict(
    ...
    bbox_head=dict(
        ...
        anchor_generator=dict(
                     ...
                     base_sizes=[[(12,12), (16, 16),(24,24), (36, 36),(12, 16),(16,24),(24,36) ],
                                [ (48, 48),(64, 64), (72,72), (96,96), (48, 64),(64,72),(72,96)]],
                     strides=[8, 16]),
...
load_from='/home/lhw/m2_disk/work_dir/cz_head_blaze/latest.pth'
